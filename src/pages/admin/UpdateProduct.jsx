...
function UpdateProduct() {
  ...
  const [showimage, setShowImage] = React.useState("https://thumbs.dreamstime.com/b/product-text-made-wooden-cube-white-background-181800372.jpg");
      ...
      <div className="manageCategoryConatiner">
          ...
          <div style={{margin:"0 auto",display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
            ...
            >
              ...
              <TextField
                ...
                sx={{ marginTop: "20px" }}
              />
              <Typography sx={{fontSize:"16px", padding:'5px', fontWeight:"600"}}>
                  Short Description
                </Typography>
        ...
        >
          <Paper elevation={2} sx={{margin:"10px auto", marginTop:"0px"}}>
            ...
              <label for="html">Electronic Gadgets</label><br/>
              <input type="radio" id="css" name="fav_language" value="CSS" />
              <label for="css">Saree</label><br/>
              <input type="radio" id="javascript" name="fav_language" value="JavaScript" />
              <label for="javascript">Shirts</label>
            <input type="radio" id="html" name="fav_language" value="HTML" />
              <label for="html">Pants</label><br/>
              <input type="radio" id="css" name="fav_language" value="CSS" />
              <label for="css">Trousers</label><br/>
              <input type="radio" id="javascript" name="fav_language" value="JavaScript" />
          ...
          <Paper elevation={2} sx={{margin:"10px auto", marginTop:"0px"}}>
              ...
              <label htmlFor="contained-button-file">
                  <img src={showimage} alt="sourceig" height="150px" width="250px" />
                <input
                  style={{ display: "none" }}
